...
locally before opening a PR. The `windows` job runs the gates and real desktop interaction tests; `CI` reports
its result for branch protection. Both existing required checks must pass:
